...
(1002, 'Essential Hypertension', 'Tăng huyết áp (Cao huyết áp)', 'I10'),
(1003, 'Deep Vein Thrombosis (DVT)', 'Huyết khối tĩnh mạch sâu (Cục máu đông)', 'I82'),
...
(1008, 'Gastroesophageal Reflux Disease (GERD)', 'Trào ngược dạ dày thực quản', 'K21'),
-- Thêm các bệnh từ drugbank_full_real (mapping từ condition_id trong file)
(1010, 'Cholera, unspecified', 'Bệnh tả không đặc hiệu', 'A009'),
(1011, 'Typhoid fever, unspecified', 'Sốt thương hàn không đặc hiệu', 'A0100'),
(1015, 'Salmonella enteritis', 'Viêm ruột Salmonella', 'A020'),
(1016, 'Salmonella sepsis', 'Nhiễm trùng huyết Salmonella', 'A021'),
(1032, 'Enteropathogenic Escherichia coli infection', 'Nhiễm E. coli gây bệnh đường ruột', 'A040'),
(1037, 'Campylobacter enteritis', 'Viêm ruột Campylobacter', 'A045'),
(1080, 'Infectious gastroenteritis and colitis, unspecified', 'Viêm dạ dày ruột nhiễm trùng', 'A09'),
(1081, 'Tuberculosis of lung', 'Lao phổi', 'A150'),
(1088, 'Tuberculous meningitis', 'Viêm màng não do lao', 'A170'),
-- Thêm 12 bệnh lý phổ biến Việt Nam
(1009, 'Hyperlipidemia', 'Rối loạn lipid máu (Mỡ máu cao)', 'E78'),
(1012, 'Coronary Artery Disease', 'Bệnh động mạch vành', 'I25'),
(1013, 'Atrial Fibrillation', 'Rung nhĩ', 'I48'),
(1014, 'Heart Failure', 'Suy tim', 'I50'),
(1017, 'Asthma', 'Hen phế quản', 'J45'),
(1018, 'Chronic Obstructive Pulmonary Disease (COPD)', 'Bệnh phổi tắc nghẽn mãn tính', 'J44'),
(1019, 'Peptic Ulcer', 'Loét dạ dày tá tràng', 'K27'),
(1020, 'Fatty Liver Disease', 'Gan nhiễm mỡ', 'K76'),
(1021, 'Rheumatoid Arthritis', 'Viêm khớp dạng thấp', 'M06'),
(1022, 'Hypothyroidism', 'Suy giáp', 'E03'),
(1023, 'Hyperthyroidism', 'Cường giáp', 'E05'),
(1024, 'Migraine', 'Đau nửa đầu (Migraine)', 'G43');
...
-- Dữ liệu cũ được giữ lại
(2001, 1001, 'Primary treatment for diabetes', 'Điều trị chính cho bệnh tiểu đường.', TRUE),
(2002, 1003, 'Prevents clot development', 'Ngăn ngừa cục máu đông phát triển.', TRUE),
(2003, 1002, 'Controls blood pressure and protects kidneys', 'Kiểm soát huyết áp và bảo vệ thận.', TRUE),
(2004, 1004, 'Iron supplementation', 'Bổ sung sắt dự trữ cho cơ thể.', TRUE),
(2005, 1005, 'Increases bone density', 'Tăng mật độ xương, giảm nguy cơ gãy xương.', TRUE),
(2006, 1006, 'Prevents acute gout attacks', 'Dự phòng cơn gút cấp.', TRUE),
(2007, 1008, 'Reduces heartburn symptoms', 'Giảm triệu chứng ợ nóng và trào ngược.', TRUE),
(2008, 1002, 'For resistant hypertension', 'Dùng cho trường hợp cao huyết áp kháng trị.', FALSE),
-- Dữ liệu từ drugbank - mapping drug_id 7 (Denileukin diftitox)
(7, 1001, 'Treatment of diabetes mellitus type 2', 'Điều trị đái tháo đường type 2', TRUE),
(7, 1002, 'Treatment of chronic pain', 'Điều trị đau mãn tính', TRUE),
-- Dữ liệu từ drugbank - mapping drug_id 27 (Sargramostim)
(27, 1080, 'Treatment of bacterial infections', 'Điều trị nhiễm khuẩn', TRUE),
(27, 1015, 'Treatment of bacterial infections', 'Điều trị nhiễm trùng Salmonella', TRUE),
-- Dữ liệu từ drugbank - Thêm các liên kết khác
(1, 1003, 'Anticoagulation in HIT patients', 'Chống đông máu cho bệnh nhân HIT', TRUE),
(9, 1003, 'Direct thrombin inhibition', 'Ức chế thrombin trực tiếp ngăn huyết khối', TRUE),
(13, 1003, 'Thrombolysis in acute stroke', 'Tiêu huyết khối trong đột quỵ cấp', TRUE),
(17, 1004, 'Stimulates red blood cell production', 'Kích thích sản xuất hồng cầu', TRUE),
(23, 1004, 'Treatment of anemia in CKD', 'Điều trị thiếu máu trong bệnh thận mãn', TRUE),
(24, 1005, 'Reduces bone resorption', 'Giảm tiêu xương trong loãng xương', TRUE),
(26, 1004, 'Reduces infection risk in neutropenia', 'Giảm nguy cơ nhiễm trùng khi giảm bạch cầu', FALSE),
(12, 1080, 'Treatment of Hepatitis C infection', 'Điều trị viêm gan C', TRUE),
(28, 1080, 'Treatment of Hepatitis C infection', 'Điều trị viêm gan C', TRUE);
...
(1, 'A comprehensive characterization of phenolics, amino acids and other minor bioactives of selected honeys and identification of botanical origin markers', 'Mật ong phân tích thành phần', TRUE, TRUE),
(2, 'A Fast and Simple Solid Phase Extraction-Based Method for Glucosinolate Determination: An Alternative to the ISO-9167 Method', 'Rau họ cải phân tích glucosinolate', TRUE, TRUE),
(3, 'A Low-Starch and High-Fiber Diet Intervention Impacts the Microbial Community of Raw Bovine Milk', 'Sữa bò tươi ít tinh bột nhiều chất xơ', TRUE, TRUE),
