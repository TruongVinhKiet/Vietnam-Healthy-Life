-- Migration: Fix calculate_daily_nutrient_intake to properly map Fiber and FattyAcid codes to Nutrient codes
-- This ensures TOTAL_FIBER maps to FIBTG and TOTAL_FAT maps to FAT, etc.
