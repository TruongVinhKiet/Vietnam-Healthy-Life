-- Migration: Fix calculate_daily_nutrient_intake - Remove non-existent columns from GROUP BY
-- Error: column f.recommended_daily does not exist
-- Error: column fa.recommended_daily does not exist
-- Fiber and FattyAcid tables don't have recommended_daily column (only Vitamin and Mineral do)
